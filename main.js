...
class Render {
  ...
  renderEvent(event) {
    ...
    const time = moment_default()(event.time).locale('ru').format('HH:mm:ss DD.MM');
...
;// CONCATENATED MODULE: ./src/js/SSE.js
class SSE {
  constructor(url) {
    this.url = url;
    this.sse = null;
...
// const url = '192.168.1.108:7070';
const url = '//ahj-lesson8-task3-backend.onrender.com';
